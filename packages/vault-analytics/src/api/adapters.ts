...
const VAULT_NFT_ABI = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'strippedReserve', type: 'uint256' },
    ...
    while (true) {
      try {
        ...
        vaults.push({
          ...
          strippedReserve: info[4] as bigint,
          mintTimestamp: info[5] as bigint,
          lastWithdrawal: info[6] as bigint,
          lastActivity: info[7] as bigint,
          pokeTimestamp: 0n,
          windowId: 0n,
