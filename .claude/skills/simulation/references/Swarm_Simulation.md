...
Invariants are checked every 50 ticks during simulation to ensure protocol correctness:
...
| Invariant check interval | `INVARIANT_CHECK_INTERVAL` in test | Every 50 ticks |
