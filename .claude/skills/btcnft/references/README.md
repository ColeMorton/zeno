...
| Document | Description |
|----------|-------------|
| [Hybrid Vault Specification](./Hybrid_Vault_Specification.md) | Dual-collateral vault: primary (cbBTC, 1% monthly) + secondary (LP tokens, 100% one-time) |

### Protocol Phases

| Document | Description |
|----------|-------------|
| [Bootstrap](./bootstrap.md) | First 1129 days: no vestedBTC, founder-led governance, match pool accumulation |

### Operations

| Document | Description |
|----------|-------------|
| [CLI Reference](./CLI.md) | Complete CLI usage: all commands, queries, workflows, and environment setup |

### Verification

| Document | Description |
|----------|-------------|
| [Simulation Result Review](./simulation.md) | Analyzing simulation output against protocol expectations: ghost variables, invariant checks, issue detection |
...
1. [CLI Reference](./CLI.md) - All commands, setup, and workflows
2. [Product Specification](./Product_Specification.md) - What the protocol does
3. [Technical Specification](./Technical_Specification.md) - Contract mechanics behind commands
